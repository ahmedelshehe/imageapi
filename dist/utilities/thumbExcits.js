...
var thumbExcits = function (fileName, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    var thumbName, thumbDir, image, imageMetadata;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                thumbName = fileName + 'thumb.jpg';
                thumbDir = path.join(__dirname, "..\\assets\\thumb\\".concat(thumbName));
                if (!(0, fs_1.existsSync)(thumbDir)) return [3 /*break*/, 3];
                return [4 /*yield*/, fs_1.promises.readFile(thumbDir)];
            case 1:
                image = _a.sent();
